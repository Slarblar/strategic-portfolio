  ...
  return (
    <>
      ...
      <div className="relative h-[150vh] bg-ink" style={{ isolation: 'isolate' }}>
        <div className="sticky top-0 full-height w-full overflow-hidden">
      ...
      <div className="relative z-[3] mt-[-150vh]">
        ...
        >
          ...
          <div className="min-h-[100dvh] flex flex-col justify-between">
            {/* Hero Text */}
            <div className="pt-20 md:pt-[17vh] pl-4 pr-6 lg:pl-8 lg:pr-12">
            ...
            {/* Scroll Indicator */}
            <div 
              className="pb-8 md:pb-[57px] mt-auto text-center transform translate-y-[-100%] md:translate-y-0 cursor-pointer group"
