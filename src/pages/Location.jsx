          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 relative">
            ...
            >
              <motion.div 
                ...
                className="absolute -inset-6 bg-gradient-to-br from-orange/15 via-olive/15 to-sky/15 rounded-3xl -z-10" 
              />
              <img src="/images/based/img/work_9.webp" alt="Design details" className="w-full h-full object-cover object-center" />
              <div className="absolute inset-0 bg-gradient-to-t from-ink/60 via-transparent to-transparent" />
              <div className="absolute bottom-4 left-4 right-4">
                <div className="font-martian-mono text-xs text-sand/80 tracking-wider">DESIGN DETAILS</div>
              </div>
            </motion.div>
